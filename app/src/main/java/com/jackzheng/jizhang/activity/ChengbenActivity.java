...
public class ChengbenActivity extends Activity{
    long time= -1;
    @Override
    ...
    private Button mButton,mReview,mSave,mClean,mAdd;
    ...
    private void iniData(){
        ...
        mAdd = (Button) findViewById(R.id.add_bt);
        mClean = (Button) findViewById(R.id.chengbeng_clean) ;
    ...
    private void saveData() {
        ...
        if(TextUtils.isEmpty(s)){
            ...
            mLevelIncome = Integer.valueOf(s);
        }
    ...
    private boolean sum(){
        ...
        Log.w("zsbin","mBiliData= "+mBiliData );
        float bili =Float.valueOf(mBiliData) /100;
        Log.w("zsbin","bili= "+bili );
        ...
        for(ChengBenData data: mListData){
            float itembili = data.isBad?bili:1.0f;
            data.price = (value3 - data.level*cha)*itembili;
...
//        }
        mAllGuest.setText((new DecimalFormat(".00")).format(value4));
